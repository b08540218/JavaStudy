...
public class Ex03ArrayList2 {
	...
	public static void main(String[] args) {
		...
		/*
		아래 2개의 컬렉션은 내부적인 자료구조만 다를뿐 구현방법에서는
		차이가 없다. 인스턴스 생성시 Student형의 타입매개변수를
		통해 생성한다. Student를 저장할 수 있는 상자가된다.
		 */
		LinkedList<Student> list2 = new LinkedList<Student>();
//		ArrayList<Student> list2 = new ArrayList<Student>();
		
		/*
		저장된 Student 인스턴스 생성, 외부패키지에 선언되었으므로
		import 후 사용할 수 있다.
		 */
		...
		갯수를 반환 받을 수 있다. 인덱스로 접근해야 하므로 get()
		메서드를 사용한다.
		 */
		...
		된다, 또한 동일한 인스턴스가 존재하면 앞에서 부터 순서대로
		삭제된다. 즉 동시에 삭제되지 않는다.
		 */
		...
		반활할 원소가 있는지 확인할 후 true이면 next()로 인출한다.
		 */
