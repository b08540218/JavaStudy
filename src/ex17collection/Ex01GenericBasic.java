...
public class Ex01GenericBasic {
	...
	public static void main(String[] args) {
		...
		/*
		아래와 같이 Orange가 아닌 인스턴스가 저장하면 즉시 컴파일러에러가
...
//		oBox1.store("당도가 20인 오렌지");
		...
		/*
		하지만 오렌지 같은 String을 저장하고, 이를 꺼내서
		다운캐스팅하는 과정에서 예외가 발생된다. 즉 런타임 에러가 발생
		하게되므로 실행전에는 오류를 예측하기 힘든 단점이 있다.
		 */
		FruitBox fBox2 = new FruitBox("당도가 30인 오렌지");
		Orange orange4 = (Orange)fBox2.pullOut(); //런타임에러
		orange4.showInfo();
	}
}
