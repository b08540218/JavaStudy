...
/*
equals()메서드
-자바에서 인스턴스 내용비교를 위해 비교연산자(==)를 사용하는것은
...
class IntNumber{
	...
	위한 코드를 기술함.
	 */
	//비교를 위해 IntNumber타입의 인스턴스를 매개변수로 받은후
...
public class E04Object2MyEquals {
	...
	public static void main(String[] args) {
		...
		/*
		String 과 같은 기본클래스는 별도의 오버라이딩 없이도 내용
		비교가 가능하다.
		 */
		...
		/*
		개발자가 직접 정의한 nyEquals를 통해 인스턴스간의 내용비교를
		한다. 여기서는 다르다고 나온다.
		 */
		if (num1.myEquals(num2)) {
			System.out.println("num1과 num2는 동일한 정수");
		} else {
			System.out.println("num1과 num2는 다른 정수");//결과
		}
		...
		if (num1.myEquals(num3)) {
			System.out.println("num1과 num2는 동일한 정수");//결과
