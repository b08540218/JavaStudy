...
-또한 개발자가 정의한 모든 클래스는 Object의 참조변수를 참조할 수 있다.
Ex) Objcet obj = new Person()
	혹은
...
class YouFriends extends Object{
	String myName;
	public YouFriends(String myName) {
		super();
		this.myName = myName;
	}
...
public class E04Object1toString {
	...
	public static void main(String[] args) {
		...
		YouFriends fnd2 = new YouFriends("헬로비너스");
		/*
		toString 메서드
