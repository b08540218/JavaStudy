...
/*
Wrapper 클래스 :  기본자료형의 데이터를 인스턴스화 할때 사용하는 클래스로
 	Boxint/Unboxing을 통해 기본자료형의 데이터를 인스턴스화 한다.
...
public class E01WrapperClass1 {
	...
	public static void main(String[] args) {
		...
		/*
		JDK 최신버전에서는 디플리케이트 되어 사용되지 않는 사용자라는
		경고 메세지가 출력된다. 구 버번과 호환성을 위해 남겨져 있는
		상태이다.
		 */
		//정수를 구 버전의 생성자를 이용해서 Boxing 처리
