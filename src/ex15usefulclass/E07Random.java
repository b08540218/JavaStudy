...
public class E07Random {
	...
	public static void main(String[] args) {
		...
		/*
		Random 클래스느 인스턴스 생성시 전달되는 인수를 기반으로
		난수를 생성한다. 이것을 Seed(씨앗)라고 표현한다.
		만약 동일한 Seed를 사용하면 항상 동일한 패턴의 난수가 생성되는대
		...
		/*
		씨드를 부여하면 setSeed메서드를 사용한다. 이때 현재시간을
		밀리세컨즈 단위로 반환하는 메서드를 사용하면 편리하다. 시간
		은 계속 흘러가므로 항상 새로운 씨드를 부여할 수 있다.
		 */
