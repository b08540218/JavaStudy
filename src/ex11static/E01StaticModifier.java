...
class MyStatic{
	...
	/*
	정적 멤버메소드 : 정적메서드 내부에서는 인스턴스형 멤버에는 접근할
		수 없다. 정적 멤버만 접근 가능하다.
		(※ main 메서드에서는 static으로 선언된 메서드만 호출할 수
		있었던 것을 기억하자)
	 */
