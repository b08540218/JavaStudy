...
public class E01OneDimArray01 {
	...
	public static void main(String[] args) {
		...
		System.out.println("numArr의 0번방의 값:"+ numArr[1]);
		System.out.println("numArr의 0번방의 값:"+ numArr[2]);
		...
		/*
		배열의 선언 및 초기화
		: 배열은 여려개의 변수를 사용하기 위해 선언하므로 접근을 위해
		일반적으로 반목문(for)을 사용한다. */
		...
		System.out.println("배열의 선언와 초기화");
...
//		int[] initArr2 = new int[3] {1, 20, 300};//에러발생
		int[] initArra2 = new int[] {1, 20, 300};
