...
public class E05TwoDimArray01 {
	...
	public static void main(String[] args) {
		...
		/*
		2차원 배열에서는 "배열원수.length"를 통해 행의 크기를 
		확인할 수 있다.
		 */
		...
		for (int i = 0; i < arr.length; i++) {
			//자차원배열에서는 각 행의 크기를 "배열명[인덱스]"를 사용
		...
		/*
		2차원배열에서 특정 원소에 접근하기 위해서는 2개의 배열기호가
		피료하다. 또한 값이 없는 원소, 즉 null로 채워져 있는 원소를
		출력하면 예외가 발생한다. (배열의 인데스를 초과하여 발생)
		 */
