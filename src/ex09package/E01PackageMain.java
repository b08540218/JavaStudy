...
public class E01PackageMain {
	...
	public static void main(String[] args) {
		...
		/*
		하나의 클래스안에 패키지는 다르나 같은 이름의 클래슬 사용해야
		한다면..
		방법1 : 클래스명 앞에 풀 패키지 경로를 서술한다.
		...
		클래스명으로 직접 메서드를 호출할수 있다.
		Java에서 제공하는 클래스중 대표적으로 Math를 예로 들수있는대
		난수생성을 위해 별도의 인스턴스 생성없이 Math.random()을
		호출할 수 있다.
		 */
		...
		if (isNum==true) {
			...
			호출할 수 있다. 이 경우에는 별도의 import가 필요하지 않다.
			 */
		System.out.println(
