...
//	public Computer() {}
	...
	public으로 지정하여 선언한 메서드. 2개의 업무를 하나로 묵었으므로
	"캡슐화" 되었다고 볼수있다.
	 */
...
class NotebookComputer extends Computer{
	...
	public void movingCal() {
		...
		/*
		어래 2개의 메서드는 private으로 선언되었으므로 상속받은
		자식클래스에서도 접근할 수 없어 에러 발생한다. 이 경우
		public으로 선언된 메서드를 통해 간접 호출한다.
		 */
		calculateFunc();
...
/*
태블릿 : 컴퓨터의 기본 계산기능과, 휴대이용 그리고 전용펜으로
...
class TableNotebook extends NotebookComputer{
	...
	//테블릿 사용을 위한 베터리 체크 및 등록된 펜인지 확인
...
public class E04ISAInheritance {
	...
	public static void main(String[] args) {
		...
		//테블릿 인스턴스 생성
		TableNotebook tablet =
				new  TableNotebook("이동욱", 5, "ISE-1234");
