...
/*
익명클래스(Anontnous class)
-이름이 없는 클래스를 말한다.
-내부클래스 처럼 이벤트 기반의 프로그래밍에서 많이 사용된다.
...
/*
인터페이스 저으이 : 기능이 없는 추상메서드만 멤버로 정의할 수 있다.
	또한 메서드 앞에너느 public abstract가 생략되어있다.
 */
interface ISinger{
	public void dancing() ;
}
public class E02AnonymousClass {
	...
	public static void main(String[] args) {
		...
		개념적으로 new GirlGroup() {};
		 ...
		 영역을 만든다고 생각하면된다.
		 */
		Singer s3 = new GirlGroup("아이린", "레드벨렛") {
