...
/*
static(정적) 형식의 상속이 되고, 하위클래스에서 접근시
...
class Adder{
	...
	/*
	static으로 선언된 멤버변수는 실제로는 클래스외부(Method영역)에 
	생성되어 있으므로 클래스명을 통한 접근이 허용된다.
	코드 레벨에서 보면 해당 클래스의 멤버변수이므로 변수명 만으로
	접근하는 것도 가능하다.
	즉, 문법적으로는 둘다 허용되는 코드이다.
	 */
 ...
 */
class AdderFirend extends Adder{
...
public class E03StaticInheritance {
	...
	public static void main(String[] args) {
		...
		Adder ad = new Adder();
		//자식클래스를 통해 인스턴스 생성
		AdderFirend adFriend = new AdderFirend();
