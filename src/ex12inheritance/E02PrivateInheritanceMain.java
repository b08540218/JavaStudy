...
class Account{
	...
	//입급처리 : protected로 선언되었으므로 상속관계에서 접근가능
	...
	//protected 멤버변수를 외부로 반환할때 사용하는 메서드(getter)
...
//		sa.money = 100000; //에러발생
		...
		변수를 통해서도 money에 접근 할 수 없다. 현재의 위치가 외부
		클래스이기 때문이다. 즉 protected 멤버는 무조건 클래스 내부에서만
		접근을 허용한다.
		 */
