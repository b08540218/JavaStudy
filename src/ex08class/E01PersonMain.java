...
대문자로 기술해야 한다. 또한 public 접근 지정자는 하나의 Java파일에
한번만 사용할 수 있다. public으로 선언하는 클래스는 해당 파일명과
일치해야한다.
 */

class Person {
	/*
	멤버변수 : 클래스에서 주로 속성(데이터)를 표헌한다. 사람을
	...
	/*
	멤버메서드 : 클래스에서 객체의 동작(횅위)를 표현한다. 클래스
	...
	/*
	넓은 지역(클래스)에서 생성된 멤버변수는 좁은지역(멤버메서드)에서
