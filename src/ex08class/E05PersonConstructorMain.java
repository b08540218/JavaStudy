...
public class E05PersonConstructorMain {
	...
	public static void main(String[] args) {
		...
		//기본생성자를 통해 인스턴스 생성
		PersonConstructor person1 = new PersonConstructor(); //인스턴스
		...
		/*
		인스턴스 생성시 초기화 메서드를 사용하면 생성과 초기화를 뱔도로
		...
		PersonConstructor person2 = new PersonConstructor("박길동"); //인스턴스
		...
		PersonConstructor person4 = new PersonConstructor("발길동", 50, "가산동");
