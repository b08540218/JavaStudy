...
public class E01StringBasic {
	...
	public static void main(String[] args) {
		 ...
		 */
		int num1=10, num2=20;
		String numResult = (num1==num2) ? "데아터가같다" : "데이터가다르다";
		System.out.println("비교결과:"+ numResult);
		
		/*
		String 클래스의 인스턴스 생성 방법
		: new를 사용한다. new를 통해 문자열 인스턴스를 생성하면
		...
		/*
		equals() 메서드 : Object클래스에서 제동하는 메서드로
