...
public class E02SilsuType {
	/*
	실수자료형
	-정수형보다는 신수형이 더큰 자료형이다. 0광1사이에 무수히 
	많은 실수가 존재하기 때문이다.
	-따라서long(정수형)과 float(실수형)을 연산하면 float의
	결과가 나오게 된다.
	 */
	public static void main(String[] args) {
		...
		long long1 = 100;
		float float1 = 200;
		//정수와 실수의 연산은 실수로 자동형변환된다.
		float result1 = long1 + float1;
		//300.0의 결과가 출력됨
		System.out.println("long1 + float = "+ result1);
		...
		/*
		-실수형의 기본은 double
		-소수점이 있는데이터를 컴파일러는 무조건 double로 인식
		-단, 수수점이 없는 데이터는 float에 대입할 수 있음
		-소수점이 있는 데이터를 float에 대입라혀면 접미사(F혹은f)를
		붙여야함
		 */
		float f3 = 100;
		...
		//강제형변활 후 대입할 수 있으나 권장하지 않음.
		float f4 = (float)3.14;
		System.out.println("f4="+ f4);
		
		//접시사를 통해 float형 자료임을 명시함(권장사항)
		float f5 = 3.14F;
		...
		//float보다는 double이 더 크므로 연산결과는 double이된다.
		double d1 = 3.14;
		double d2 = f6 + d1;
