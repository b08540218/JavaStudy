...
public class E01JunsuType {
	...
	일반적으로 CPU(중앙처리장치)는 장수형 연산을  가장 빠르게
	...
	public static void main(String[] args) {
		...
		반환하고 싶다면 형변환(Type casting)을 해야한다.*/
		result1 = int1 / int2;
		System.out.println("int1 / int2 = "+ result1);
		...
		자동 형변환된다. 이유는 데이터의 손실(오차)이 있을 수 있기 때문이다.
		-단, byte와 short는 에외적인 상황으로 생각하면 된다. cpu가
